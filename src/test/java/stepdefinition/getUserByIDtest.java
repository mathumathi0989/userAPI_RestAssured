...
public class getUserByIDtest {
	...
	@Given("Send POST to {string}")
	public void send_post_to(String endpoint, DataTable dataTable) {
	...
	@Then("user got created")
	public void user_got_created() {
	...
	public void store_the_response_userid() {
	...
	@Then("validate response with status code {int}")
	public void validate_response_with_status_code(int statusCode) {
	...
	@When("I send a {string} request to {string} with stored user ID and auth as {string}")
	public void i_send_a_request_to_with_stored_user_id_and_auth_as(String method, String endpoint, String auth) {
	...
	@Then("Validate {string} and other user validations for scenario name as {string}")
	public void validate_user_and_other_validations_for_scenario_name_as(String expectedStatusCodeStr, String scenarioName) {
	...
	@When("I send a DELETE to {string} with the stored user ID")
	public void i_send_a_delete_to_with_stored_user_id(String endpoint) {
